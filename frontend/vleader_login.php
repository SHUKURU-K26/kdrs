...
<head>
    ...
    <title>KDRS - Village Leader Login</title>
...
<body>
    <div class="container">
        ...
        <main>
            ...
            <?php
                ...
                if (isset($_POST["Login"])) {
                    ...
                    $stmt = $conn->prepare('SELECT *  FROM village_leaders WHERE vleader_password=? AND vleader_phone= ? ');
                    ...
                    if ($row){
                            $_SESSION["village_leader"] = $row["vleader_password"];
                            $_SESSION["vleader_id"]=$row["vleader_id"];
                            header("location: ./village_leaders/vleader_home.php");
                            exit();
                    } 
                    else{
                        ...
                        <script>
                          setTimeout(()=>{
                           window.location.href='./vleader_login.php';
                          }, 2000)
                        </script>
                        ";
                    }
        ...
        ?>
                <h2>Muhisemo Kwinjira nk’ Umuyobozi W'Umudugudu</h2>
                ...
                <div class="fields">
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"])?>" method="POST">
                            ...
                            <div class="div-btn">
                                <button name="back"  id="back" style="background-color: orange;">Ahabanza</button>
