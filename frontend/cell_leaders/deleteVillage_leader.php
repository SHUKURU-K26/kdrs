...
<head>
    ...
    <title>Delete Village Leader</title>
    <link rel="stylesheet" href="../../web_styles/deleteVillage_leader.css">
        ...
        <div class="section-two">
              ...
              <form action="" method="POST">
                     <div class="delete-cell-form">
                        <p> Confirm Deletion of <span style="color:hsl(216, 60%, 14%);font-weight:bold;">
                            <?php echo $row["vleader_f_name"] ." ". $row["vleader_s_name"]."'s"?> </span>Account</p>
            ...
            ?>
                ...
                if (isset($_POST["deleteBtn"])) {
                    $sql="DELETE  FROM village_leaders WHERE vleader_id='$vleader_id'";
                    $query=$conn->query($sql);
                    if ($query) {
                      ...
                      echo"
                       <script>
                         setTimeout(()=>{
                          window.location.href='./view_village_leaders.php';
                    }, 2000);
                       </script>
                      ";
                    }
