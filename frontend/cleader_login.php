...
<body>
    <div class="container">
        ...
        <main>
            ...
            <?php
                ...
                if (isset($_POST["Login"])) {
                    ...
                    $stmt = $conn->prepare('SELECT *  FROM cell_leaders WHERE cleader_password=? AND cleader_phone= ? ');
                    ...
                    if ($row){
                            $_SESSION["cell_leader"] = $row["cleader_password"];
                            $_SESSION["cleader_id"]=$row["cleader_id"];
                            header("location: ./cell_leaders/cleader_home.php");
                            exit();
                    } 
                    else{
                        ...
                        <script>
                          setTimeout(()=>{
                           window.location.href='./cleader_login.php';
                          }, 2000)
                        </script>
                        ";
                    }
        ...
        ?>
                <h2>Muhisemo Kwinjira nk’ Umuyobozi W'Akagali</h2>
