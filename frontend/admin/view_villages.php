...
<body>
        ...
        <div class="containers" style="height: 700px;overflow-y:scroll;">
            <table border="2px">
                <tr style="background-color: hsl(216, 88%, 20%);color: white;">
                    ...
                    <th style="width: 200px;" >CORRESPONDENT CELL</th>
                    <th style="width: 200px;" >CORRESPONDENT SECTOR</th>
                    <th style="width: 200px;" colspan="2" >ACTION</th>
                </tr>
                <?php
                  include "../../web_connection/connection.php";
                  $sql="SELECT villages.village_id, villages.village_name, cells.cell_name,sector_name 
                  FROM villages
                   INNER JOIN cells ON villages.cell_id=cells.cell_id
                   INNER JOIN sectors ON sectors.sector_id=cells.sector_id";
                    ...
                    while($row=$query->fetch_assoc()){
                        ...
                        <tr>
                            ...
                            <td><?php echo $row["sector_name"]?></td>
                                ...
                                <form action="update_village.php" method="GET">
                                ...
                                <form action="delete_village.php" method="GET">
                                    <input type="hidden" name="village_id" value="<?php echo $row["village_id"]?>">
                                    <td style="cursor: pointer;">
  ...
  <script>
      let sentence="TABLE-SHOWING-ALL-REGISTERED-VILLAGES";
