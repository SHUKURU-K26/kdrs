...
<body>
    ...
    <div class="sections">
        ...
        <div class="containers">
            ...
            $sql="SELECT * FROM sectors WHERE sector_id='$sector_id'";
            ...
            ?>
              <form action="" method="POST">
                     <div class="new-sector-form">
                        <p>UPDATE <?php echo $row["sector_name"]?> SECTOR</p>
                        <input type="text" name="sector" id="sector"  value="<?php echo $row['sector_name']?>" required>
            ...
            ?>
                ...
                if (isset($_POST["save"])) {
                    ...
                    $sql="UPDATE sectors SET sector_name='$sector' WHERE sector_id='$sector_id'";
                    $query=$conn->query($sql);
                    if ($query) {
                      echo"<p id='success-message'>Sector Updated Successfully</p>";
                      echo"
                       <script>
                         setTimeout(()=>{
                          window.location.href='./view_sectors.php';
                    }, 2000);
                       </script>
                      ";
                    }
  ...
  <script>
      let sentence="MAKE SOME CHANGES";
