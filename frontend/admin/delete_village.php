                ...
                <ul>
                    ...
                    <li><i style="font-size: 30px;" class="fa-solid fa-list-check"></i><a href="#">Administration &#9660</a>
                            <ul class="dropdown">
                                ...
                                <li><a href="./nvillage.php">Cell</a></li>
        ...
        <div class="containers">
            ...
            ?>
              <form action="" method="POST">
                     <div class="delete-sector-form">
                        <p> Confirm Deletion of <?php echo $row["village_name"]?> Village</p>
            ...
            ?>
                ...
                if (isset($_POST["deleteBtn"])) {
                    $sql="DELETE  FROM villages WHERE village_id='$village_id'";
                    $query=$conn->query($sql);
                    if ($query) {
