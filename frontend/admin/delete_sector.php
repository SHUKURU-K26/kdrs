                ...
                <ul>
                    ...
                    <li><i style="font-size: 30px;" class="fa-solid fa-list-check"></i><a href="#">Administration &#9660</a>
                            <ul class="dropdown">
                                ...
                                <li><a href="./new_category.php">Districts</a></li>
                            </ul>
                    </li>
        ...
        <div class="containers">
            ...
            ?>
              <form action="" method="POST">
                     <div class="delete-sector-form">
                        <p> Confirm Deletion of <?php echo $row["sector_name"]?> Sector</p>
            ...
            ?>
                ...
                if (isset($_POST["deleteBtn"])) {
                    $sql="DELETE  FROM sectors WHERE sector_id='$sector_id'";
                    $query=$conn->query($sql);
                    if ($query) {
